...
$(function () {
  ...
  if ($('div').is('.stages-block')) {
    ...
    $(window).on('scroll', function () {
      var blockPosition = $('.stages-block').offset().top,
  ...
  $("section h1, section h2, h2+.descr, \
		...
		.service2__item, \
		.article ").animated("fadeInUp", "fadeInUp"); // Слева направо

  $(".subtitle, \
		.maps .dealer:nth-child(odd) .dealer-info").animated("fadeInLeft", "fadeInLeft"); // Справа налево
  ...
  $(".banner-form, \
		...
		.order__item, \
		.order__list .dot, \
		aside").animated("fadeInRight", "fadeInRight"); // Animations End
  ...
  var arrow2 = '<svg width="25" height="15" viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.35929 12.9725L12.2089 2.97248L23.0586 12.9725" stroke="#35628A" stroke-width="4"/></svg>'; //Banner Slider
  ...
  $('.reviews__letter').slick({
    ...
    }, _defineProperty(_ref, "breakpoint", 576), _defineProperty(_ref, "settings", {
      slidesToShow: 1,
      slidesToScroll: 1,
      adaptiveHeight: false,
      autoplay: true
  ...
  function myResize() {
    ...
    var bannerSlideH = winH - 94; // ШИИРИНА
  ...
  $("form").submit(function () {
    ...
    $.ajax({
      ...
      var res = JSON.parse(data); // console.log( ["success data:", data, res, res.error] );
  ...
  $('a[href="#cheaper"]').on('click', function () {
    ...
    if (servName) $('#cheaper').find('h3').text(servName);else $('#cheaper').find('h3').text($(this).text());
  });
...
$(function () {
  ...
  function init() {
    ...
    var myPlacemarkTemp = new ymaps.Placemark(this.position, {
    ...
    var layer = myMapTemp.layers.get(0).get(0),
        parent = this.parent; // Решение по callback-у для определния полной загрузки карты
  ...
  function ymap(map) {
    jQuery(map.parent).one("mouseenter", function () {
      ...
      if (!start_load_script) {
        ...
        start_load_script = true; // Загружаем API Яндекс.Карт

        loadScript("https://api-maps.yandex.ru/2.1/?lang=ru_RU&loadByRequire=1", function () {
          end_load_script = !end_load_script; // Как только API Яндекс.Карт загрузились, сразу формируем карту и помещаем в блок с идентификатором "map-yandex"
...
(function (root, factory) {
  ...
  */
  ...
  LazyLoad.prototype = {
    ...
    oneFunc: function oneFunc(smth) {
      var src = smth.getAttribute(this.settings.src);
      var srcset = smth.getAttribute(this.settings.srcset);
      var srcbefore = smth.getAttribute(this.settings.srcbefore);
      var srcafter = smth.getAttribute(this.settings.srcbefore);
      var srcclass = smth.getAttribute(this.settings.srcclass);
      var srcbackground = smth.getAttribute(this.settings.srcbackground);
      var srcbackgroundimageset = smth.getAttribute(this.settings.srcbackgroundimageset);
      var removeSelector = false;
      var notRemoveLazyclassNow = false;
      ...
      if ('img' === smth.tagName.toLowerCase()) {
        ...
        var img = smth.querySelector('img');
        var append = false;
        ...
        var imageSetLinks = srcbackgroundimageset.split(',');
    ...
    removeSelector: function removeSelector(smth) {
    ...
    loadImg: function loadImg(url, callback) {
  ...
  $.fn.lazyload = function (images, options) {
  ...
  if (root.jQuery) {
    ...
    _$.fn.lazyload = function (options) {
      options = options || {};
      options.attribute = options.attribute || "data-src";
      new LazyLoad(_$.makeArray(this), options);
      return this;
    };
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkmu"] = self["webpackChunkkmu"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/libs/Magnific-Popup-master/jquery.magnific-popup.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/libs/slick/slick.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/libs/animate/animate-css.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/libs/lazyload.min.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/libs/waypoint.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/js/map.js")))
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/js/common.js")))
